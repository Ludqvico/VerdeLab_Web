    ...
    >
      {src ? (
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <span className="font-serif italic text-5xl text-ink/10 select-none">
            0{index + 1}
          </span>
        </div>
      )}
    ...
    <>
      ...
      <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-10 md:mb-14">
        <div>
          ...
          <motion.h2
            className="font-serif italic text-display-lg md:text-display-md text-ink leading-[0.9] md:leading-[0.85]"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
        {suggestions.map((s, i) => (
          <motion.div
            ...
            className="group relative md:h-[320px] rounded-2xl border border-border bg-surface hover:border-teal/25 hover:bg-white/80 p-7 flex flex-col justify-between overflow-hidden transition-colors duration-500"
          >
            {/* Ambient teal glow */}
            <div
            ...
            <div className="flex items-start justify-between relative z-10">
              <div className="w-10 h-10 rounded-xl bg-teal/10 flex items-center justify-center shrink-0 border border-teal/5 group-hover:bg-teal/20 transition-colors duration-500">
                <Icon
            ...
            <div className="mt-8 relative z-10">
              <h3 className="font-sans font-semibold text-base text-ink mb-2 group-hover:text-teal transition-colors duration-300">
                {s.title}
              </h3>
              <p className="font-sans text-sm text-ink-secondary leading-relaxed line-clamp-2">
                {s.tagline}
              </p>
            </div>

            {/* Bottom: tags + arrow icon */}
            <div className="flex items-center justify-between mt-6 md:mt-auto pt-4 relative z-10 border-t border-border/50">
              <div className="flex flex-wrap gap-1.5">
                {s.tags.slice(0, 2).map((t) => (
                  <span
                    key={t}
                    className="font-sans text-[10px] uppercase tracking-wider px-2 py-0.5 rounded-full bg-border/30 text-ink-tertiary"
                  >
                    {t}
                  </span>
                ))}
              </div>
              <div className="w-8 h-8 rounded-full bg-surface-2 border border-border flex items-center justify-center group-hover:bg-teal group-hover:text-white group-hover:border-teal transition-all duration-300">
        ...
        >
          ...
          <div className="relative z-10 max-w-7xl mx-auto">
            ...
            >
              <Link
                ...
                className="inline-flex items-center gap-2 font-sans text-xs text-ink-tertiary hover:text-teal transition-colors duration-200 uppercase tracking-[0.15em]"
              >
                <span>←</span>
                <span>Cosa costruiamo</span>
              </Link>
            </motion.div>
          ...
          <div className="grid md:grid-cols-[3fr_2fr] gap-10 md:gap-16 items-end">
            ...
            <div className="w-full max-w-full overflow-hidden">
              <motion.h1
                className="font-serif italic text-[3.2rem] xs:text-[3.8rem] sm:text-display-lg leading-[0.95] xs:leading-[0.82] md:leading-[0.85] mb-6 pb-6 bg-clip-text text-transparent break-words"
            ...
            <motion.div
              className="w-full border border-border rounded-2xl overflow-hidden bg-white/50 backdrop-blur-sm mt-2 md:mt-0"
      ...
      >
        <div className="max-w-7xl mx-auto grid md:grid-cols-12 gap-12 md:gap-16">
          ...
          <div className="md:col-span-5">
            ...
            <motion.h2
              className="font-serif italic text-display-lg md:text-display-md text-ink leading-[0.9] md:leading-[0.85] mb-6"
              initial={{ opacity: 0, filter: "blur(8px)" }}
              whileInView={{ opacity: 1, filter: "blur(0px)" }}
              viewport={{ once: false, margin: "-10%" }}
              transition={{ duration: 0.85, delay: 0.08, ease: EASE }}
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          >
            <Link
              href="/#services-anchor"
              className="inline-flex items-center gap-2 font-sans text-[11px] uppercase tracking-[0.18em] text-ink-tertiary hover:text-teal transition-colors duration-200"
            >
